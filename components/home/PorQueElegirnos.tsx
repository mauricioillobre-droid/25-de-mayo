...
const puntos = [
  {
    ...
    descripcion: 'Clínica médica, pediatría, neurología, cardiología y mucho más. Todo el cuidado que necesitás, bajo el mismo techo.',
    icon: (
  ...
  },
  {
    ...
    descripcion: 'Cada paciente es único. Nuestros profesionales se toman el tiempo necesario para escucharte y orientarte en cada consulta.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.8}>
  ...
  },
  {
    ...
    descripcion: 'Coordiná tu turno cuando lo necesites, sin llamadas ni esperas. Te respondemos a la brevedad en horario de atención.',
    icon: (
